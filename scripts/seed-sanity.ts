...
async function main() {
  ...
  tx.createOrReplace({
    ...
    categoryCtaPrimaryHref: '/make-an-enquiry',
  ...
  tx.createOrReplace({
    ...
    heroSlides: [
      ...
      },
      {
        ...
        cta: 'Learn More',
        ctaHref: '/more-lubrication/remote-greasing-equipment',
      },
      {
        _key: key(),
    ...
    welcomeCtaHref: '/catalogue-library',
    ...
    solutionCards: [
      {
        ...
        href: '/more-lubrication/remote-greasing-equipment',
        emoji: '🔧',
      },
      {
        _key: key(),
    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          ...
          {_key: key(), label: 'Catalogue', href: '/catalogue-library'},
          {_key: key(), label: 'Contact', href: '/make-an-enquiry'},
        ],
      },
      {
        _key: key(),
