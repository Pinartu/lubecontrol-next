...
/** Only allow PDF preview from trusted sources */
const TRUSTED_PREVIEW_HOSTS = ['cdn.sanity.io']
...
/**
 * Sanity (and many CDNs) send X-Frame-Options so the PDF cannot be embedded on our origin.
 * Google Docs viewer loads the file in a context that typically works in an iframe.
 */
function previewEmbedUrl(originalUrl: string): string {
  try {
